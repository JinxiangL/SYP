...
public class Face extends Frame
{
    ...
    public void closeConnection() throws IOException
    {
        ...
        {
            // close the connection for client
            this.server.getClients().close();
            this.server.getClients().getOutputStream().close();
            this.server.getClients().getInputStream().close();
            //.server.getClients().stop();
